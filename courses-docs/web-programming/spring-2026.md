...
* Students will build a web application step by step, based on a previous year version of
  https://web.aintlab.com (features may be added or removed depending on weekly topics).
